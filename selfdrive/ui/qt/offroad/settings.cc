...
CarrotPanel::CarrotPanel(QWidget* parent) : QWidget(parent) {
  ...
  startToggles->addItem(new CValueControl("EnableRadarTracks", "Enable Radar Track", "1:Enable RadarTrack, -1:Disable use HKG SCC radar at all times", "../assets/offroad/icon_shell.png", -1, 1, 1));
